...
$con = sqllink();
$query = mysqli_query($con,"SELECT id,user_from,date,content FROM message WHERE id = '{$_GET['action']}' LIMIT 1");
$result = mysqli_fetch_array($query,MYSQLI_ASSOC);
mysqli_query($con,"UPDATE message SET status=1 WHERE id='{$_GET['action']}'LIMIT 1");
