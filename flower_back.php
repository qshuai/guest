...
<div id="message">
      ...
      <form action="?action=back" method="post">
            <dl>
                  ...
                  <dd>回赠 <input type="number" class="text" name="num" style="width: 100px;" value="99">  朵花</dd>
                  <dd><textarea class="text" name="content" cols="26" rows="5" style="font-weight: bold;">感谢您送的花朵，我也表达一下我的心意，望收下哦！</textarea></dd>
